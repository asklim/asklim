...
import type { Request, Response, ResponseMessage } from '../types';
export declare function send200Ok(res: Response, msg?: ResponseMessage): Response<any, Record<string, any>>;
