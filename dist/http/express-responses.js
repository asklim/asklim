...
function send200Ok(res, msg = status_codes_object_1.default[status_codes_object_1.default.OK]) {
    return sendJSONResponse(res, status_codes_object_1.default.OK, msg);
}
exports.send200Ok = send200Ok;
function send201Created(res, msg = status_codes_object_1.default[status_codes_object_1.default.CREATED]) {
    return sendJSONResponse(res, status_codes_object_1.default.CREATED, msg);
}
exports.send201Created = send201Created;
function send204NoContent(res, msg = status_codes_object_1.default[status_codes_object_1.default.NO_CONTENT]) {
    return sendJSONResponse(res, status_codes_object_1.default.NO_CONTENT, msg);
}
exports.send204NoContent = send204NoContent;
function send400BadRequest(res, msg = 'BAD_REQUEST (invalid syntax)') {
    return sendJSONResponse(res, status_codes_object_1.default.BAD_REQUEST, msg);
}
exports.send400BadRequest = send400BadRequest;
function send401UnAuthorized(res, msg = 'UnAuthorized') {
    return sendJSONResponse(res, status_codes_object_1.default.UNAUTHORIZED, msg);
}
exports.send401UnAuthorized = send401UnAuthorized;
function send404NotFound(res, msg = status_codes_object_1.default[status_codes_object_1.default.NOT_FOUND]) {
    return sendJSONResponse(res, status_codes_object_1.default.NOT_FOUND, msg);
}
exports.send404NotFound = send404NotFound;
// Метод запроса не разрешен к использованию для данного URL
function send405MethodNotAllowed(res, msg = status_codes_object_1.default[status_codes_object_1.default.METHOD_NOT_ALLOWED]) {
    return sendJSONResponse(res, status_codes_object_1.default.METHOD_NOT_ALLOWED, msg);
}
exports.send405MethodNotAllowed = send405MethodNotAllowed;
function send409Conflict(res, msg = status_codes_object_1.default[status_codes_object_1.default.CONFLICT]) {
    return sendJSONResponse(res, status_codes_object_1.default.CONFLICT, msg);
}
exports.send409Conflict = send409Conflict;
function send500ServerError(res, msg = status_codes_object_1.default[status_codes_object_1.default.INTERNAL_SERVER_ERROR]) {
    return sendJSONResponse(res, status_codes_object_1.default.INTERNAL_SERVER_ERROR, msg);
}
exports.send500ServerError = send500ServerError;
function send503ServiceUnavailable(res, msg = status_codes_object_1.default[status_codes_object_1.default.SERVICE_UNAVAILABLE]) {
    return sendJSONResponse(res, status_codes_object_1.default.SERVICE_UNAVAILABLE, msg);
}
