...
const weeks_1 = __importDefault(require("asklim/weeks"));
...
function factory(options) {
    ...
    function mappedUnixTime(atDate) {
        ...
        */
        ...
        return (baseUTC + Math.round((ONE_DAY - DELTA) * valueX / ONE_DAY));
    }
    /**
    ...
    function theMappedDeltaDate(startDate, offset = 0) {
        ...
        return new Date(mappedUnixTime(startDate) + ONE_DAY * offset);
    }
    /**
    ...
    **/
    ...
    const week = (atDate = toISODay()) => weeks_1.default.week21c(atDate);
    return {
        week,
        toISODay,
        today,
...
//# sourceMappingURL=workDate.js.map